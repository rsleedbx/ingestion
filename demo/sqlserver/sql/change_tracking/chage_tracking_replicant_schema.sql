-- the tables require enable change tracking
-- don't 

create schema if not exists replicant;

CREATE TABLE replicant."replicate_io_audit_ddl"  (
...
ALTER TABLE replicant."replicate_io_audit_ddl" ENABLE CHANGE_TRACKING;

CREATE TABLE replicant."replicate_io_audit_tbl_schema"
(
"COLUMN_ID" BIGINT, 
"DATA_DEFAULT" BIGINT, 
...
ALTER TABLE replicant."replicate_io_audit_tbl_schema" ENABLE CHANGE_TRACKING;

CREATE TABLE  replicant."replicate_io_audit_tbl_cons"
(
...
ALTER TABLE replicant."replicate_io_audit_tbl_cons" ENABLE CHANGE_TRACKING;
...
BEGIN
    INSERT INTO replicant."replicate_io_audit_ddl" 
